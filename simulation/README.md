...
The ```data``` folder includes ```0_lidar_data``` and ```other_data```. These files should be put into a simulation version folder (e.g: Put them into folder version_001 used to generate simulations of rotation and North-East translation).
