...
hex_list52 = ["#00aaff", "#0072aa", "#1c4d31", "#bd7e00", "#ffaa00"]
hex_list53 = ["#954151", "#db9793", "#ead98b", "#7295bf", "#1d4e89"]
hex_list54 = ["#0080ff", "#005bb2", "#472459", "#c40f0f", "#ff4d4d"]
hex_list55 = ["#a00000", "#df7b7b", "#dae695", "#47b0df", "#008fbf"]
hex_list56 = ["#a00000", "#df7b7b", "#dae695", "#47b0df", "#008fbf"]
