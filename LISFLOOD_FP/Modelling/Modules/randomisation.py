...
def random_transformation(num_seed=1,
                          ...
                          type_random='uniform',
                          replacement=False):
    """This function is to generate random numbers for angle, x, and y.
    If 'systematic', the values for rotation and translation will be chosen with intervals.
    If 'uniform', the values for rotation and translation will be chosen randomly without replacement.

    -----------
    References: https://florimond.dev/en/posts/2018/08/python-mutable-defaults-are-the-source-of-all-evil/
